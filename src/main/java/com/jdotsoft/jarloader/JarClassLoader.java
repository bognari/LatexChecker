...
public class JarClassLoader extends ClassLoader {
  ...
  /**
   * VM parameter key to define mLog area.
  ...
  /**
   * VM parameter key to define mLog level.
  ...
  /**
   * Sub directory mName for temporary files.
   * <p/>
  ...
  public JarClassLoader(ClassLoader parent) {
    ...
    if ("file".equals(protocol)) {
      ...
      //    URL.getmFile() returns "/C:/my%20dir/MyApp.jar" for "/C:/my dir/MyApp.jar"
      try {
   ...
   * @throws IllegalArgumentException If package mName duplicates an existing package either in this
  ...
  /**
   * Returns the mName of the jar file main class, or null if
   ...
   *
   * @param sClass       class mName in form "MyClass" for default package
  ...
  private void initLogger() {
    ...
    if (sLogger != null) {
      try {
        ...
        logError(LogArea.CONFIG, "Cannot create mLog file %s.", sLogger);
      }
    }
   ...
   *
   * @param sLib Library mName. For example for the library mName "Native"
  ...
  private JarEntryInfo findJarNativeEntry(String sLib) {
    ...
    for (JarFileInfo jarFileInfo : lstJarFile) {
      ...
      while (en.hasMoreElements()) {
        ...
        //   - in the partial mName: abc/aNative.dll   <-- do not load this one!
        String[] token = sEntry.split("/"); // the last token is library mName
   ...
   *
   * @param sName resource mName including path.
   * @return normalized resource mName.
   */
  ...
  private void loadJar(JarFileInfo jarFileInfo) throws IOException {
    ...
    try {
      ...
      while (en.hasMoreElements()) {
        ...
        String s = je.getName().toLowerCase(); // JarEntry mName
